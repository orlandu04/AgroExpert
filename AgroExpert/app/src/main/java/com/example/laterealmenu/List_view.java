...
public class List_view extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] nombreElementos = {"Laura","Mariana","Jorge","Pablo","Pepe"};
        int[] elementoImagen = {R.drawable.instagram, R.drawable.spotify, R.drawable.wasa, R.drawable.faceboolk, R.drawable.youtube};
        Adaptador customAdapter = new Adaptador(getActivity(), nombreElementos, elementoImagen);
